...
parser.add_argument('--gt_paths', type=list, default=['/home/ubuntu/data1/lk/msra_lmk','/home/ubuntu/data1/lk/celebrity_lmk'],
...
parser.add_argument('--lmdb_path', type=str, default='./lmdb_default_full',
