...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers):
        ...
        self.fc5 = nn.Linear(512*block.expansion*7*7, 512)
        self.bn5 = nn.BatchNorm1d(512)
        # self.avgpool = nn.AvgPool2d(7, stride=1) # 对于224*224的图，到这里特征图尺寸为7*7×channel
        ...
        for m in self.modules():
            ...
            elif isinstance(m, nn.BatchNorm2d) or isinstance(m, nn.BatchNorm1d):  # TODO
                m.weight.data.fill_(1)
                m.bias.data.zero_()
            elif isinstance(m, nn.Linear): # TODO
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers.append(block(self.inplanes, planes, use_se=True))
