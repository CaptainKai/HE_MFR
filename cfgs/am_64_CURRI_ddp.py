...
# about model
name = "amsoft-64"
backbone_model_name = "SimpleResnet_64"
...
# about file
log_interval = 100
log_path = "./logs/am_64_CURRI_ddp_test.log"
log_pic_path = "./logs/pic/am_64_CURRI_ddp_test/"
save_path = 'snapshot/am_64_CURRI_ddp_test/'
