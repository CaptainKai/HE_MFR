...
backbone_model_name = "SimpleResnet_atten_split_abla_36" # SimpleResnet_fullsplit_36
classify_model_name = "MarginCosineProduct" # DCFace
resume_net_model = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/SResnet_36_atten_split_b3/backbone_25_checkpoint.pth"
# resume_net_model = None
# resume_net_classifier = None
resume_net_classifier = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/SResnet_36_atten_split_b3/classifier_status_25_checkpoint.pth"
...
# about file
log_interval = 100
log_path = "./logs/SResnet_36_atten_split_b3.log"
log_pic_path = "./logs/pic/SResnet_36_atten_split_b3/"
save_path = 'snapshot/SResnet_36_atten_split_b3/'
...
# dist_backend = 'nccl'
# distributed = True
# master_port = 32320 # 多个训练任务同时进行ddp训练的时候，保证两个任务的该参数值不同
