...
# about file
log_interval = 100
log_path = "./logs/SResnet_36_split_noDrop_noLA_b3_LR.log"
log_pic_path = "./logs/pic/SResnet_36_split_noDrop_noLA_b3_LR/"
save_path = 'snapshot/SResnet_36_split_noDrop_noLA_b3_LR/'
