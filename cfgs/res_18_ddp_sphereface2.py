...
# resume_net_model = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/am_20_ddp_test/backbone_291_checkpoint.pth"
resume_net_model = None
resume_net_classifier = None
# resume_net_classifier = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/am_20_ddp_test/classifier_status_291_checkpoint.pth"
...
# about file
log_interval = 100
log_path = "./logs/res_18_ddp_sphereface2.log"
log_pic_path = "./logs/pic/res_18_ddp_sphereface2/"
save_path = 'snapshot/res_18_ddp_sphereface2/'
...
dist_backend = 'nccl'
distributed = True
master_port = 33345 # 多个训练任务同时进行ddp训练的时候，保证两个任务的该参数值不同
