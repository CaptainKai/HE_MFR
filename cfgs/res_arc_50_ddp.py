...
# about file
log_interval = 100
log_path = "./logs/res_arc_50_sphereNorm.log"
log_pic_path = "./logs/pic/res_arc_50_sphereNorm/"
save_path = 'snapshot/res_arc_50_sphereNorm/'
lmdb_path = "/home/ubuntu/data4/lk/data/lmdb_default" # TODO
# lmdb_path = "/home/ubuntu/data4/lk/data/lmdb_mask_augu_full" # TODO
# lmdb_path = "/data1/lk/data/lmdb_default"
# about data
batch_size = 512 # 768
# batch_size = 512 # 768
...
dist_backend = 'nccl'
distributed = True
master_port = 32323 # 多个训练任务同时进行ddp训练的时候，保证两个任务的该参数值不同
