...
# resume_net_model = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/SResnet_36_split_noDrop_noLA_b3_init_casia/backbone_20_checkpoint.pth"
resume_net_model = None
resume_net_classifier = None
# resume_net_classifier = "/home/ubuntu/data2/lk/recognition/pytorch_new/snapshot/SResnet_36_split_noDrop_noLA_b3_init_casia/classifier_status_20_checkpoint.pth"
...
# about file
log_interval = 100
log_path = "./logs/SResnet_36_split_noDrop_noLA_b3_init_tri_3branch.log"
log_pic_path = "./logs/pic/SResnet_36_split_noDrop_noLA_b3_init_tri_3branch/"
save_path = 'snapshot/SResnet_36_split_noDrop_noLA_b3_init_tri_3branch/'
...
batch_size = 512 # 768
# batch_size = 512 # 768
datanum = 3923399  # 3923399 6753545 3074286（filter）3913769 # TODO 493733
num_class = 86876 # 86876, 180855 46346（filter）# TODO 10575
lmdb_workers = 4
num_workers = 4

# about LR policy
start_epoch = 1
# max_epoch = 65 # casia 40
max_epoch = 26
