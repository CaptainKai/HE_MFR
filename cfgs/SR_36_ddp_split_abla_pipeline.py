...
# about model
name = "amsoft-36"
description = "双分支（缩短到仅多分出来一个fc），特征不裁剪，两个分支均进行混合人脸训练"
# about data
data_settings = {
    "training" :{
        "batch_size" : 512, # 768
...
common_settings={
    "backbone":{
        ...
        "settings": [
            {
                "backbone_model_name" : "SimpleResnet_36", # SimpleResnet_split_abla_36
                "args" :{
                    "input_size":[112,112],
                    # "cl": True,
                    "fc_num":2,
...
log_settings ={
    "training":{
        "log_path" : "./logs/sr_36_fc_bothMix_seperate.log",
        "log_pic_path" : "./logs/pic/sr_36_fc_bothMix_seperate/",
        "save_path" : 'snapshot/sr_36_fc_bothMix_seperate/',
        "log_interval" : 100,
